...
const TORTOISE_STORY = {
  id: "the-tortoise-and-the-hare",
  title: "The Tortoise and the Hare",
} as const;
const SMARTPHONE_STORY = {
  id: "my-first-smartphone",
  title: "My First Smartphone",
} as const;

// Seed words are all chosen so each has a precomputed practice set — Practice
// never falls through to "coming soon". The sentencesReady mix shows both the
// "Review" (>0) and "Practice" (0) card states; both open real sentences.
const savedWordsSeed: SavedWord[] = [
  {
    id: "path",
    word: "Path",
    translation: "sendero, camino",
    sourceStoryId: TRIP_STORY.id,
    sourceStoryTitle: TRIP_STORY.title,
    sentencesReady: 10,
  ...
  },
  {
    ...
    sourceStoryId: TORTOISE_STORY.id,
    sourceStoryTitle: TORTOISE_STORY.title,
    sentencesReady: 10,
  ...
  },
  {
    ...
    sourceStoryId: SMARTPHONE_STORY.id,
    sourceStoryTitle: SMARTPHONE_STORY.title,
    sentencesReady: 0,
